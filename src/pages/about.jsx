    ...
    <HomeLayout>
      ...
      <Box width="inherit" pt={4} mb={4}>
        ...
        <Text fontFamily="body" fontSize={2} lineHeight={1.5} mb={3}>
          ...
          mainly using React JS and modern javascript to deliver business-driven
          web or web-applications with solid, tested, and scalable architecture
          design. I get used to coding with clean, error-safe, and testable
          code, with a #FunctionalProgramming paradigm.
        </Text>
        <Text fontFamily="body" fontSize={2} lineHeight={1.5} mb={3}>
